              ...
              return (
                <View key={c.id} style={styles.courseCard}>
                  <View style={styles.courseHeader}>
                    ...
                    <View style={[styles.statusPill, { backgroundColor: active ? '#EDE9FE' : '#F3F4F6' }]}>
                      <Text style={[styles.statusText, { color: active ? '#7C3AED' : '#6B7280' }]}>
...
const styles = StyleSheet.create({
  ...
  greetingSub: { color: '#C4B5FD', fontSize: 12, marginTop: 4, marginBottom: 20 },
